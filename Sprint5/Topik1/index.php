...
<body>
    ...
    spl_autoload_register("autoloadLing");
    ...
    spl_autoload_register("autoloadPerseg");

    new Persegipanjang();
    $persegipanjang->Perseg();
    ?>
    <?php
    function autoloadSeg($class)
    {
    ...
    spl_autoload_register("autoloadSeg");
